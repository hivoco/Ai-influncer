...
`;
  useEffect(() => {
    ...
    //   const campaign = parsedCampaigns.find(
  ...
  const handleGeneratePost = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //   campaign_id: "a46a18c2-af1e-11f0-b03d-0a88edf1954d",
      //   persona_id: "904127b5-af1e-11f0-b03d-0a88edf1954d",
      //   platform_id: "92df89c7-a9c3-11f0-b03d-0a88edf1954d",
      //   title: "Celebrate Radiant Skin This Holiday Season with Dove",
      //   user_prompt:
      //     "Make it sound festive, warm, and emotionally uplifting, focusing on self-care and gifting.",
      // });
                      ...
                      >
                        ...
                        {/* <div className="grid grid-cols-3 gap-2 text-xs text-gray-500">
                          <div className="bg-gray-100 rounded px-2 py-1 text-center">
                            Tone: {persona.tone_formal}/10
                          </div>
                          <div className="bg-gray-100 rounded px-2 py-1 text-center">
                            Witty: {persona.tone_witty}/10
                          </div>
                          <div className="bg-gray-100 rounded px-2 py-1 text-center">
                            Aspiration: {persona.tone_aspirational}/10
                          </div>
                        </div>
